...
execute unless entity @e[predicate=moon:boss/king_magma_cube] run function lunartech:math/chance {chance:140,command:"function moon:mobs/entity/types/convert/boss/king_magma_cube"}
