...
execute if predicate moon:boss/spawns/brood_spawn/can_spawn if entity @a[distance=..50] run schedule function moon:effects/boss/broodmother/broodspawn/schedule 1s
