...
execute as @e[type=item,predicate=items:tag/craftable_with,predicate=machines:fuel/all,distance=...7,sort=nearest,limit=1] run function machines:fuel_units/add_fuel/main {type:"all"}
