...
execute if entity @e[type=item,predicate=items:tag/craftable_with,predicate=machines:fuel/pulverizer,distance=...7,limit=1] run function machines:fuel_units/add_fuel/main {type:"pulverizer",distance:.7}
