...
execute if entity @e[predicate=items:tag/craftable_with,predicate=!machines:fuel/all,distance=...7] run return run function machines:molten_forge/input/has_item
