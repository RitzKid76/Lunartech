...
execute if entity @e[predicate=items:tag/craftable_with,predicate=!machines:fuel/all,distance=...7] if function machines:cooking_station/recipes/main run function machines:craft_item
