...
execute if function machines:upgrades/biosphere_radiation_shield_upgrade/condition run return run function machines:biosphere/upgrades/biosphere_radiation_shield_upgrade
return 0
