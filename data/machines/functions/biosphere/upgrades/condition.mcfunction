...
execute if function machines:upgrades/condition/biosphere_gravity_regulator_upgrade run return run function machines:biosphere/upgrades/biosphere_gravity_regulator_upgrade
