#> .:biosphere/states/oxygenator/use_oxygen/get_entities
...
return run function machines:biosphere/states/as_contained_entity/macro with storage machines:state biosphere
