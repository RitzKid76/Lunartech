...
execute if entity @e[type=item,predicate=items:tag/craftable_with,predicate=!machines:fuel/normal,distance=...7,limit=1] run return run function machines:quarry/input/has_item
