...
execute store result storage machines:state quarry.volume.x int 1 run scoreboard players get x0 machines.state
execute store result storage machines:state quarry.volume.z int 1 run scoreboard players get z0 machines.state
