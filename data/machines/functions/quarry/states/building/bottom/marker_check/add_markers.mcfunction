...
execute as @e[type=item_display,tag=machines.quarry.building.quarry_marker] run data modify storage machines:state quarry.markers prepend from entity @s UUID
