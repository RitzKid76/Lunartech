...
execute if predicate machines:is/quarry if entity @a[distance=..30] run return run function machines:quarry/main
execute if predicate machines:is/molten_forge if entity @a[distance=..30] run return run function machines:molten_forge/main
