...
$execute as @e[predicate=items:tag/craftable_with,predicate=machines:fuel/$(type),distance=...7,sort=random,limit=1] store result score fuel machines.fuel run function machines:fuel_units/get_fuel/main
