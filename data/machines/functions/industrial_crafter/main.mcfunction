...
execute if entity @e[type=item,predicate=items:tag/craftable_with,predicate=!machines:fuel/all,distance=...7] if function machines:industrial_crafter/recipes/main run function machines:craft_item
