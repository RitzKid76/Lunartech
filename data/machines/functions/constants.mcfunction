...
scoreboard players set #quarry machines.process_time 200
scoreboard players set #quarry machines.fuel 2048

scoreboard players set #molten_forge machines.process_time 200
scoreboard players set #molten_forge machines.fuel 256
